"""Environment-backed settings for the Peer Affinity API.

Each field is read from the environment variable of the same name in upper
case (peer_affinity_file -> PEER_AFFINITY_FILE), falling back to a .env file
...
class Settings(BaseSettings):
    ...
    peer_affinity_file: Path = Field(
        default=_HERE / "peer_affinity_scores.json",
